...
content = open('config/workflow_checklist_annotate_v2.json', encoding='utf-8-sig').read()
...
open('config/workflow_checklist_annotate_v2.json', 'w', encoding='utf-8').write(content)
import json, re
