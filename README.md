...
目前的架构是一个基于神经科学设计的多智能体论文写作协作系统，采用"大脑皮层-小脑-海马体-基底节"四层神经网络架构类比构建 Multi-Agent System，专为学术论文（LaTeX）写作场景设计。
...
- **Phase 2**：MAS 集成 + Router + RAG + 上下文管理
